...
header('location:index.php');
	...
	{		
		...
		$sql ="INSERT INTO students(name,email, phone,  academy, num_co, pass) VALUES(:name, :email, :phone,  :academy, :num_co, :pass)";
		$query = $dbh->prepare($sql);
		$query-> bindParam(':name', $name, PDO::PARAM_STR);
		$query-> bindParam(':email', $email, PDO::PARAM_STR);
		$query-> bindParam(':phone', $phone, PDO::PARAM_STR);
		$query-> bindParam(':academy', $academy, PDO::PARAM_STR);
        $query-> bindParam(':num_co', $num_co, PDO::PARAM_STR);
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="post">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                <select class="form-select mb-3" aria-label="Default select example" name="academy" required>
...
{				?>
                            ...
                            <?php $cnt=$cnt+1; }} ?>
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Students Name </label>
                                    <div class="col-sm-4">
...
<div class="col-sm-4">
   <select class="form-select mb-3" aria-label="Default select example" name="num_co" required>
...
{				?>	
										<tr>
                                            ...
                                            <td><?php echo htmlentities($result->academy) ?></td>
                                            <td><?php  echo htmlentities($result->num_co) ;?> </td>
